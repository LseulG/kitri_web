...
<body>
	<div class="testbox box1">
		...
		필수입력<br>
		<input type="text" name="name" id="name" value="<%=memberDetailDto.getName() %>" size="12"  required/>
		<input type="text" name="id" id="id" value="" size="12" readonly="readonly" readonly="readonly" required/>
	...
	<!--	&nbsp;&nbsp;<font color="#3cb371">6~12</font>자리의 영문(대소문자 구별)이나 숫자	-->
	    ...
	    <input type="text" name="address_detail" id="address_detail" value="" size="100" placeholder="Address2" />    
	    </div>
	    <br>
	    <input type="button" value="회원수정" class="button" onclick="javascript:join();"/>&nbsp;&nbsp;
